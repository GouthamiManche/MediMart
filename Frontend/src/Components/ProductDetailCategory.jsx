...
function ProductDetailCategory({ category , pg }) {
...
const categoryParam = queryParams.get('category');
  ...
  const handleCategoryFilter = (category) => {
    ...
    navigate(`?category=${category}&pg=1`);
  };
  ...
  useEffect(() => {
    ...
    const filterData = () => {
      if (category !== "") {
        ...
        console.log('No Category Selected, Displaying All Data');
...
//console.log('Filtered Data:', filteredData);
  const handleCategoryClick = () => {
    navigate(`/category-shop?category=${category}&pg=1`);
  };
